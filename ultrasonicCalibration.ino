...
void loop() {
  ...
  duration1 = pulseIn(echoPin1, HIGH, 10000); //arduino will only wait 10000 microseconds for the pulse to be complete
  distance1 = (0.01858166411 * duration1) - 0.9295852502;
  
  //prints data to the serial port as human readable ASCII text
  Serial.print(" cm_Dist1  ");
  ...
  duration2 = pulseIn(echoPin2, HIGH, 10000); //arduino will only wait 10000 microseconds for the pulse to be complete
  distance2 = (0.01791104649 * duration2) + 0.1096452067;


  //prints data to the serial port
  Serial.println(" cm_Dist2");
